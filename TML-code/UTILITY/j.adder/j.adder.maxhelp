...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.0, 60.0, 50.0, 22.0 ],
													"style" : "",
													"text" : "0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 120.0, 15.0, 49.0, 22.0 ],
													"style" : "",
													"text" : "j.model"
												}
...
,
									"patching_rect" : [ 525.0, 255.0, 37.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 180.0, 390.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.0, 435.0, 97.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 435.0, 97.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 360.0, 157.0, 65.0 ],
									"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
									"setminmax" : [ -2.0, 2.0 ],
									"setstyle" : 5,
									"slidercolor" : [ 0.690196, 0.023529, 0.101961, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 90.0, 150.0, 175.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 165.0, 270.0, 82.0, 22.0 ],
									"style" : "",
									"text" : "lfo.model lfo2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 300.0, 157.0, 65.0 ],
									"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
									"setminmax" : [ -2.0, 2.0 ],
									"setstyle" : 5,
									"slidercolor" : [ 0.690196, 0.023529, 0.101961, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 90.0, 150.0, 175.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 82.0, 22.0 ],
									"style" : "",
									"text" : "lfo.model lfo1"
								}
...
, 							{
								"box" : 								{
									"args" : [ "@name", "j.adder", "@description", "Sum the values of two Jamoma parameters and forward the sum to a third Jamoma parameter." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 174.5, 325.5, 24.5, 325.5 ],
									"source" : [ "obj-48", 0 ]
								}
...
, 			{
				"name" : "j.adder.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/UTILITY/j.adder",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
