...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 181.0, 240.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "delay 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 181.0, 215.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 379.0, 66.0, 106.0, 22.0 ],
					"style" : "",
					"text" : "j.namespace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 282.5, 107.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 316.0, 178.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 342.0, 109.0, 203.0, 22.0 ],
					"style" : "",
					"text" : "j.receive v:/scale/out/final"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ -14.0, 401.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Declare a remote patch as a Minuit device called \"application_with_views\""
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Declare this patch as a Minuit device called \"application_with_models\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 350.0, 105.0, 22.0 ],
					"style" : "",
					"text" : "j.modular v Minuit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 224.0, 154.0, 22.0 ],
					"style" : "",
					"text" : "j.modular Minuit @name m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 309.0, 154.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 183.0, 154.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 562.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.0, 461.0, 61.0, 21.0 ],
					"style" : "",
					"text" : "saw~ 330"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 318.0, 461.0, 52.0, 21.0 ],
					"style" : "",
					"text" : "tri~ 220"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 504.5, 165.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.0, 282.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
