...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 75.0, 15.0, 242.0, 29.0 ],
									"style" : "",
									"text" : "inky_particles"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 210.0, 330.0, 80.0, 35.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "gl_inky_particles.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 120.0, 300.0, 210.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 300.0, 230.0, 22.0 ],
									"style" : "",
									"text" : "gl_inky_particles.model cc_inky_particles"
								}
...
, 			{
				"name" : "gl_inky_particles.model.maxpat",
				"bootpath" : "~/Desktop/gl_inky_particles",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
