...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 187.833333, 220.5, 154.9, 220.5 ],
									"source" : [ "obj-39", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 144.5, 220.5, 134.7, 220.5 ],
									"source" : [ "obj-39", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 209.5, 220.5, 289.9, 220.5 ],
									"source" : [ "obj-39", 3 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 166.166667, 220.5, 269.7, 220.5 ],
									"source" : [ "obj-39", 1 ]
								}
...
, 							{
								"box" : 								{
									"code" : "Param mouse(0., 0.);\nParam click(0.);\r\nParam time(0.);\r\n\r\nee = vec(1./dim.x, 1./dim.y, 0.);\nq = norm;\n\nc = sample(in1, q);\n\np11 = c.x;\n\n//orthogonal coordinate offsets for sampling second buffer\r\ns = vec(q.x, q.y - ee.y);\r\nw = vec(q.x - ee.x, q.y);\r\nea = vec(q.x + ee.x, q.y);\r\nn = vec(q.x, q.y + ee.y);\r\n\r\n//sample orthogonal neighbouring pixels from second buffer\r\np10 = sample(in2, s);\np01 = sample(in2, w);\np21 = sample(in2, ea);\np12 = sample(in2, n);\r\n\r\nd=0;\nif (click > 0.) \n\t{\n\t// Mouse interaction:\n\t// (Note: for both the mouse and the raindrops,\r\n\t// I scaled the first value of smoothstep up to 100\r\n\t// to make the dots more visible.)\r\n\td = smoothstep(100.5,.5,length(mouse - cell));\n\t}\n\telse\n\t{\n\t// Simulate rain drops\n\tt = time*2.;\n    pos = fract(floor(t)*vec(0.456665,0.708618)*dim);\n\tamp = 1.-step(.05,fract(t));\t\r\n\td = -amp*smoothstep(100.5,.5,length(pos*dim - cell));\n   }\n\r\n   // The actual propagation:\r\n\t// (Comment out line 51 and uncomment line 52 to see\r\n\t// the problem. Line 52 incorporates the values of\r\n\t// the neighbouring cells from the other buffer. This \r\n\t// should make the wave propagation happen. When\r\n\t// this line is used, however, the output immediately\r\n\t// goes black. After switching back, you'll need to\r\n\t// hit the reset message in the main patch to get it\r\n\t// working again.)\r\n\td += -(p11-.5)*2.;\r\n//\td += -(p11-.5)*2. - (p10 + p01 + p21 + p12 - 2.);\r\n\td *= 0.99; // dampening\n\td *= min(1.,time); // clear the buffer at time == 0\n\t// I removed the *0.5 from the following line since it\r\n\t// seems to push the output/feedback towards black.\r\n\td = d + .5;\n   \n   out1 = vec(d, 0, 0, 0);",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 15.0, 645.0, 150.0, 35.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 155.5, 703.0, 193.5, 703.0, 193.5, 529.0, 114.5, 529.0 ],
					"order" : 1,
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 90.0, 706.5, 24.5, 706.5 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 155.5, 706.5, 114.5, 706.5 ],
					"order" : 0,
					"source" : [ "obj-2", 2 ]
				}
