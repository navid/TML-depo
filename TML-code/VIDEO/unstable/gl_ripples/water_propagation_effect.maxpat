...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 705.0, 120.0, 390.0, 610.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									"code" : "Param mousexy(0., 0.);\nParam click(0.);\r\nParam time(0.);\r\n\r\nee = vec(1./dim.x, 1./dim.y, 0.);\nq = norm;\n\nc = sample(in1, q);\n\np11 = c.x;\n\np10 = sample(in2, q-ee.zy).x;\np01 = sample(in2, q-ee.xz).x;\np21 = sample(in2, q+ee.xz).x;\np12 = sample(in2, q+ee.zy).x;\n\r\nd=0;\ndd = 0.;\nddd = 0.;    \nif (click > 0.) \n\t{\n\t// Mouse interaction:\n\tdd = smoothstep(100.5,.5,length(mousexy - cell));\n\t}\n\telse\n\t{\n\t// Simulate rain drops\n\tt = time*2.;\n    pos = fract(floor(t)*vec(0.456665,0.708618)*dim); // maybe specify all components individually\n\tamp = 1.-step(.05,fract(t));\n\tddd = -amp*smoothstep(100.5,.5,length(pos*dim - cell)); // maybe specify all components of pos - cell individually\n   }\n\r\n   // The actual propagation:\n   d += -(p11-.5)*2. + (p10 + p01 + p21 + p12 - 2.);\n   d *= 1; // dampening\n//   d *= min(1.,time); // clear the buffer at iFrame == 0\n   d = d*.5 + .5;\n   \n   out1 = vec(d+dd+ddd, 0, 0, 0);\r\n//out1 = vec(pos.x,pos.y,0,0);\n//\tout1 = vec(floor,t,0,0);",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-3",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 279.5, 537.0, 86.0, 537.0, 86.0, 414.0, 129.5, 414.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 534.5, 405.0, 279.5, 405.0 ],
					"order" : 0,
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 624.5, 405.0, 279.5, 405.0 ],
					"order" : 0,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 129.5, 600.0, 129.5, 600.0 ],
					"order" : 1,
					"source" : [ "obj-51", 0 ]
				}
