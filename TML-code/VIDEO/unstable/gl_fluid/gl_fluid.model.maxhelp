...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 105.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "close"
								}
...
, 							{
								"box" : 								{
									"annotation" : "Fluid solver from the C74 forum.",
									"id" : "obj-1",
									"maxclass" : "newobj",
									"numinlets" : 2,
									"numoutlets" : 4,
...
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_fluid.model", "@description", "Fluid simulation in Gen from the C74 forum." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 99.5, 138.0, 54.5, 138.0 ],
									"source" : [ "obj-11", 0 ]
								}
