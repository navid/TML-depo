...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 195.0, 165.0, 33.0 ],
									"style" : "",
									"text" : "input = list of numbers (int or float), up to 32 elements."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 165.0, 135.0, 50.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"size" : 32,
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 90.0, 300.0, 70.0 ],
...
, 							{
								"box" : 								{
									"annotation" : "Convert numerical lists of up to 32 elements to OpenGL textures.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 240.0, 141.0, 22.0 ],
									"style" : "",
									"text" : "gl_list2tex.model list2tex"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_list2tex.model", "@description", "Convert numerical lists of up to 32 elements to OpenGL textures.." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
