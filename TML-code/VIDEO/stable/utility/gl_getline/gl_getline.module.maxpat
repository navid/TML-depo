...
, 			{
				"box" : 				{
					"annotation" : "Readback video from the GPU using jit.gl.asyncread.",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-28",
					"maxclass" : "newobj",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/stable/utility/gl_asyncread%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
