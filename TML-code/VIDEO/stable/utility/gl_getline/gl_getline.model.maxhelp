...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 45.0, 270.0, 80.0, 35.0 ],
									"presentation_rect" : [ 141.0, 298.0, 0.0, 0.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 150.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "close"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 195.0, 149.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 120.0, 214.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_getline.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 90.0, 150.0, 70.0 ],
...
, 							{
								"box" : 								{
									"annotation" : "Extract a horizontal or vertical line of pixels from a texture.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 225.0, 137.0, 22.0 ],
									"style" : "",
									"text" : "gl_getline.model getline"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_getline.model", "@description", "Extract a horizontal or vertical line of pixels from a texture." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 24.5, 258.0, 54.5, 258.0 ],
									"order" : 0,
									"source" : [ "obj-13", 0 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-34::obj-3::obj-3" : [ "live.text", "live.text", 0 ],
			"obj-34::obj-3::obj-18" : [ "live.text[2]", "live.text[2]", 0 ],
			"obj-34::obj-3::obj-16::obj-46" : [ "live.text[1]", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "j.maxhelpui.maxpat",
...
, 			{
				"name" : "gl_getline.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/stable/utility/gl_getline",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
