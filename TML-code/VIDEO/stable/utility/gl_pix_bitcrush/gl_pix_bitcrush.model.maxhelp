...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_pix_bitcrush.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"annotation" : "Reduce bit depth of video, making colour steppy.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 285.0, 194.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_bitcrush.model pix_bitcrush"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_pix_bitcrush.model", "@description", " Reduce bit depth of video, making colour steppy." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				"name" : "gl_pix_bitcrush.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_pix_bitcrush",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
