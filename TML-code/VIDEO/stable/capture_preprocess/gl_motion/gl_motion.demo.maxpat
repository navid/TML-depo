...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 15.0, 210.0, 152.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 45.0, 277.0, 22.0 ],
					"style" : "",
					"text" : "jit.grab @output texture 1 @vdevice -1 @unique 1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "gl_motion.module.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/development/gl_motion",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
