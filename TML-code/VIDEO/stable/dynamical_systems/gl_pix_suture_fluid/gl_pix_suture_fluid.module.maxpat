...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 140.0, 111.0, 22.0 ],
					"style" : "",
					"text" : "gl_pix_vf.model #1",
					"varname" : "j.model"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Github/TML-depo.bak/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_pix_vf",
				"patcherrelativepath" : "../../../../../../../../Github/TML-depo.bak/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_pix_vf",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
