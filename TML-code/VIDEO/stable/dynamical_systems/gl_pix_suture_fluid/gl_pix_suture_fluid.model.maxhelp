...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 75.0, 150.0, 33.0 ],
									"style" : "",
									"text" : "https://www.shadertoy.com/view/XddSRX"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 270.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "close"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 300.0, 220.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.world sf_help @enable 1 @fsmenubar 0"
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_pix_suture_fluid.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"annotation" : "Reaction-diffusion system by cornusammonis from Shadertoy.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 330.0, 159.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_suture_fluid.model sf"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_pix_vf.model", "@description", "Reaction-diffusion cellular automata shader from Shadertoy." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				"name" : "gl_pix_suture_fluid.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/stable/dynamical_systems/gl_pix_suture_fluid",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
