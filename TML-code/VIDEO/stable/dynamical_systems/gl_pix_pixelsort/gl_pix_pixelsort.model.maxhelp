...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 300.0, 226.0, 22.0 ],
									"style" : "",
									"text" : "jit.grab @output_texture 1 @type float32"
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_pix_pixelsort.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 330.0, 177.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_pixelsort.model pixelsort"
								}
...
, 			{
				"name" : "gl_pix_pixelsort.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/stable/dynamical_systems/gl_pix_pixelsort",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
