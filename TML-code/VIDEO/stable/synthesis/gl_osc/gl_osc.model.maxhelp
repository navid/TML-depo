...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 255.0, 335.0, 114.0 ],
									"style" : "",
									"text" : "thresh: If the input is above this value, the output value will   \n            rise. If it's below this value, the output value will fall.\nsaw:     When this is on, if the output level reaches 1 it will \n            reset to 0, generating a sawtooth.\nup/dn:  Set the rate at which the output value rises and falls.\nlo/hi:    Set the values at which the output is clamped.\nzoom:  Zoom the input texture.\noffset:  Spatially offset the input texture."
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 120.0, 300.0, 105.0 ],
...
, 							{
								"box" : 								{
									"annotation" : "Threshold-controlled GL video ramp/oscillator.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 103.0, 22.0 ],
									"style" : "",
									"text" : "gl_osc.model osc"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_osc.model", "@description", "GL-based video ramp/oscillator." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
