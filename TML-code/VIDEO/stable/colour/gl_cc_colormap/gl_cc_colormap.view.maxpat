...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 391.0, 270.0, 24.0, 21.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 72.0, 24.0, 24.0 ],
					"style" : "",
					"varname" : "TOL[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 150.0, 315.0, 84.0, 21.0 ],
					"presentation_rect" : [ 150.0, 316.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "j.remote alpha",
					"varname" : "tolerance[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 285.0, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 72.0, 63.0, 19.0 ],
					"style" : "",
					"text" : "interp"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 48.0, 50.0, 21.0 ],
					"style" : "",
					"triangle" : 0,
					"varname" : "TOL[2]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 48.0, 63.0, 19.0 ],
					"style" : "",
					"text" : "mapdim"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 95.0, 190.0, 73.0, 21.0 ],
									"style" : "",
									"text" : "pack set 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 95.0, 145.0, 62.0, 21.0 ],
									"style" : "",
									"text" : "t b i i"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 66.5, 271.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 391.0, 305.0, 118.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 510.0, 350.0, 60.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 48.0, 46.0, 45.0 ],
					"setminmax" : [ 0.0, 255.0 ],
					"setstyle" : 1,
					"settype" : 0,
					"size" : 256,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 450.0, 350.0, 60.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 48.0, 46.0, 45.0 ],
					"setminmax" : [ 0.0, 255.0 ],
					"setstyle" : 1,
					"settype" : 0,
					"size" : 256,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 391.0, 350.0, 60.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 48.0, 46.0, 45.0 ],
					"setminmax" : [ 0.0, 255.0 ],
					"setstyle" : 1,
					"settype" : 0,
					"size" : 256,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 391.0, 230.0, 36.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 24.0, 36.0, 21.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 150.0, 165.0, 77.0, 21.0 ],
					"style" : "",
					"text" : "j.remote amt",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 24.0, 63.0, 19.0 ],
					"style" : "",
					"text" : "amt"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 337.5, 400.5, 337.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 337.5, 459.5, 337.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 337.5, 519.5, 337.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 159.5, 339.0, 135.0, 339.0, 135.0, 279.0, 159.5, 279.0 ],
					"source" : [ "obj-9", 0 ]
				}
