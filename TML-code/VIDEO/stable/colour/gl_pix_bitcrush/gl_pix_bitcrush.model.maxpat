...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 150.0, 68.0, 21.0 ],
					"style" : "",
					"text" : "bitdepth $1"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "j.parameter bitdepth @type decimal @range 1. 200. @description \"Bit depth of video signal.\" @clipmode low",
					"varname" : "tolerance[2]"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 15.0, 104.0, 22.0 ],
									"style" : "",
									"text" : "param bitdepth 1."
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 60.0, 150.0, 45.0 ],
					"style" : "",
					"text" : "j.model @description \"Reduce bit depth of video, making luminance steppy.\"",
					"varname" : "jmod.hub"
				}
