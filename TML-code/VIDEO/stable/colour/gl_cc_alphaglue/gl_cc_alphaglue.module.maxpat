...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 90.0, 27.0, 27.0 ],
					"presentation_rect" : [ 225.0, 96.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "gl_cc_alphaglue.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 140.0, 150.0, 22.0 ],
					"style" : "",
					"text" : "gl_cc_alphaglue.model #1",
					"varname" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 90.0, 27.0, 27.0 ],
					"style" : ""
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "gl_cc_alphaglue.model.maxpat",
				"bootpath" : "~/Code/TML-depo/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_bloom 2",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
