...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_pix_brcosa.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"annotation" : "jit.gl.pix-based brightness/contrast/saturation effect.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 285.0, 182.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_brcosa.model pix_brcosa"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_pix_brcosa.model", "@description", "jit.gl.pix-based brightness/contrast/saturation effect." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
