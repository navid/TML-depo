...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 177.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_thresh.model pix_thresh"
								}
