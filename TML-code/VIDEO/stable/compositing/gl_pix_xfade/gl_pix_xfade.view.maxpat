...
, 			{
				"box" : 				{
					"annotation" : "Toggle to select whether the shader is used to process pixels (off) or vertices (on). For vertex processing, the shader must be used with e.g. Tom W's particleshader_2.jxs.",
					"id" : "obj-8",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 48.0, 18.0, 18.0 ],
					"style" : "",
					"varname" : "TOL[3]"
				}
