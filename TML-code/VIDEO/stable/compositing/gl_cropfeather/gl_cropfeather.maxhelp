...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 195.0, 135.0, 49.0 ],
									"style" : "",
									"text" : "jit.movie @output_texture @moviefile dvkite.mov"
								}
...
, 							{
								"box" : 								{
									"annotation" : "Crop and edge feather, with individual control over each edge.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 187.0, 22.0 ],
									"style" : "",
									"text" : "gl_cropfeather.model cropfeather"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_cropfeather.model", "@description", "Crop and edge feather, with individual control over each edge." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
