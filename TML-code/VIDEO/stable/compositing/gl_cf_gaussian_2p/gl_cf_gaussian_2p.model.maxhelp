...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 150.0, 206.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 237.0, 22.0 ],
									"style" : "",
									"text" : "gl_cf_gaussian_2p.model cf_gaussian_2p"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_cf_gaussian_2p.model", "@description", "Slab-based Gaussian blur." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				...
				"bootpath" : "~/Downloads/_Jitter research/_Shader modules/gl_cf_gaussian_2p",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
