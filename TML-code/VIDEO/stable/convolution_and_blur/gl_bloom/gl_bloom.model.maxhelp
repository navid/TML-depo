...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.world bloom_help @enable 1"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "gl_bloom.model bloom"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_bloom.model", "@description", "Slab-based bloom effect." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				...
				"bootpath" : "~/Code/TML-depo/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_bloom",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
