...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.world erode_help @enable 1"
								}
...
, 							{
								"box" : 								{
									"annotation" : "Shader-based erode effect.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"style" : "",
									"text" : "gl_cf_erode.model cf_erode"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_cf_erode.model", "@description", "Slab-based erode effect." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
