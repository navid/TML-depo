...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 180.0, 151.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 75.0, 60.0, 135.0, 57.0 ],
					"style" : "",
					"text" : "j.parameter width @type decimal @range 0. 10. @description Dilate width. @clipmode low",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 60.0, 165.0, 33.0 ],
					"style" : "",
					"text" : "j.model @description \"Shader-based dilate effect.\"",
					"varname" : "jmod.hub"
				}
