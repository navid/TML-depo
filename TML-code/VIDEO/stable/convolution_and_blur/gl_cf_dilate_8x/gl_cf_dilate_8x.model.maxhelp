...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 345.0, 100.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 150.0, 174.0, 22.0 ],
									"style" : "",
									"text" : "jit.world dilate_help @enable 1"
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_cf_dilate_8x.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 180.0, 300.0, 105.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 300.0, 194.0, 22.0 ],
									"style" : "",
									"text" : "gl_cf_dilate_8x.model cf_dilate_8x"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_cf_dilate_8x.model", "@description", "Slab-based dilate effect (8x multipass)." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				"name" : "gl_cf_dilate_8x.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/stable/convolution_and_blur/gl_cf_dilate_8x",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
