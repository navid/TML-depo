...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.world sobel_help @enable 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 167.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_sobel.model pix_sobel"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_pix_sobel.model", "@description", "Sobel edge detection in jit.gl.pix." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
