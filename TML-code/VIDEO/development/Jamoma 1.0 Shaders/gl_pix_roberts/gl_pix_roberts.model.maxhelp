...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 150.0, 183.0, 22.0 ],
									"style" : "",
									"text" : "jit.world roberts_help @enable 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 185.0, 22.0 ],
									"style" : "",
									"text" : "gl_pix_roberts.model pix_roberts"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_pix_roberts.model", "@description", "Robert's Cross edge detection in jit.gl.pix." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
