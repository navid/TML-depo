...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 180.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "j.parameter width @type decimal @range 0. 10. @description Erode width. @clipmode low",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 60.0, 198.0, 33.0 ],
					"style" : "",
					"text" : "j.model @description \"Shader-based erode effect.\"",
					"varname" : "jmod.hub"
				}
