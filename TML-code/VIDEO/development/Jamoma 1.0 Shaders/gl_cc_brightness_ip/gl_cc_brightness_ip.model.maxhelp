...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_cc_brightness_ip.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"annotation" : "Shader-based brightness adjustment.",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 285.0, 211.0, 22.0 ],
									"style" : "",
									"text" : "gl_cc_brightness_ip.model cc_brcosa"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_cc_brightness_ip.model", "@description", "Shader-based brightness adjustment." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				"name" : "gl_cc_brightness_ip.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/development/Jamoma 1.0 Shaders/gl_cc_brightness_ip",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
