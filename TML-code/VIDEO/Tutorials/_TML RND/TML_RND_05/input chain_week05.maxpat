...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 390.0, 1260.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 315.0, 1260.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 1230.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 1290.0, 100.0, 100.0 ],
					"rightvalue" : 100,
					"style" : "",
					"topvalue" : 100
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 90.0, 1275.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 90.0, 1185.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "j.sum%"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 1080.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 45.0, 1110.0, 70.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 735.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 750.0, 150.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 60.0, 1350.0, 232.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 1305.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 1062.0, 105.5, 1062.0 ],
					"source" : [ "obj-25", 0 ]
				}
