...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 149.0, 22.0 ],
									"style" : "",
									"text" : "gl_tp_slide.model tp_slide"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "gl_tp_slide.model", "@description", "Slab-based temporal interpolation." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 			{
				...
				"bootpath" : "~/Downloads/_Jitter research/_Shader modules/gl_tp_slide",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
