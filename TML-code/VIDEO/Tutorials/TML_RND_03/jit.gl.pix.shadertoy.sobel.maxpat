...
,
		"openrect" : [ 30.0, 30.0, 270.0, 434.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 164.0, 148.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 180.0, 62.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 270.0, 75.0, 18.0 ],
					"text" : "thresh $1"
				}
...
,
					"patching_rect" : [ 135.0, 300.0, 83.0, 20.0 ],
					"text" : "jit.gl.pix sobel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 30.0, 61.0, 18.0 ],
					"text" : "vdevice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 360.0, 240.0, 47.0 ],
					"text" : "Sobel edge detection in jit.gl.pix\nTranslated from\nhttps://www.shadertoy.com/view/XssGD7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 60.0, 39.0, 18.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 60.0, 38.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 105.0, 105.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 330.0, 120.0, 33.0 ],
...
,
					"patching_rect" : [ 15.0, 165.0, 40.0, 20.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 90.0, 144.5, 90.0 ],
					"source" : [ "obj-1", 0 ]
				}
