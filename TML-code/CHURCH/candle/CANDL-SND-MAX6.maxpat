...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 314.0, 74.0, 36.0, 20.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 355.0, 279.5, 50.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 186.0, 74.0, 18.0 ],
					"presentation_rect" : [ 288.0, 95.0, 0.0, 0.0 ],
					"text" : "0, 100 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 167.0, 77.0, 18.0 ],
					"text" : "100, 0. 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 208.0, 198.0, 46.0, 20.0 ],
					"text" : "line 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 228.0, 83.0, 18.0 ],
					"text" : "audio/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 314.0, 46.0, 32.5, 20.0 ],
					"text" : "> 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 613.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 14.0, 99.0, 20.0 ],
					"text" : "udpreceive 8674"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 412.0, 167.0, 150.0, 245.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 265.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 240.0, 300.0, 140.0 ],
					"varname" : "rogsSur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 522.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-108::obj-101" : [ "Scrub[1]", "Scrub", 0 ],
			...
			"obj-4::obj-89" : [ "lock[1]", "Lock", 0 ],
			"obj-4::obj-69" : [ "SelectFile[1]", "SelectFile", 0 ],
			"obj-4::obj-68" : [ "DropFile[1]", "DropFile", 0 ],
			"obj-4::obj-108::obj-87" : [ "Direction[10]", "Direction", 0 ],
			"obj-4::obj-74" : [ "note[1]", "Note", 0 ],
			"obj-4::obj-108::obj-67" : [ "SelectAll[4]", "SelectAll", 0 ],
			"obj-4::obj-108::obj-103" : [ "Direction[9]", "Direction", 0 ],
			"obj-4::obj-108::obj-32" : [ "live.text[7]", "live.text[3]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "jmod.sur.output~.maxpat",
...
, 			{
				"name" : "jmod.nav.rogs~.maxpat",
				"bootpath" : "/Users/aquaphoneia/Documents/Github/Nav-master/Jamoma/jmod.nav.rogs~",
				"patcherrelativepath" : "../../../../Nav-master/Jamoma/jmod.nav.rogs~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "/Users/aquaphoneia/Documents/Github/Nav-master/Jamoma/jmod.nav.oscRoute",
				"patcherrelativepath" : "../../../../Nav-master/Jamoma/jmod.nav.oscRoute",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "jmod.nav.scale.maxpat",
				"bootpath" : "/Users/aquaphoneia/Documents/Github/Nav-master/Jamoma/jmod.nav.scale",
				"patcherrelativepath" : "../../../../Nav-master/Jamoma/jmod.nav.scale",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
