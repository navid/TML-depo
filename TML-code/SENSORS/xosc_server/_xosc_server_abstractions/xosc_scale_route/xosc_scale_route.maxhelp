...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 90.0, 142.0, 22.0 ],
									"style" : "",
									"text" : "xosc_scale_route /xosc1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 120.0, 165.0, 33.0 ],
									"style" : "",
									"text" : "Takes one argument (name of x-OSC capture module)."
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "xosc_scale_route", "@description", "Used as part of xosc_server. Routes x-OSC parameters to a udpsend." ],
									"bgmode" : 1,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 0.0, 0.0, 420.0, 75.0 ],
