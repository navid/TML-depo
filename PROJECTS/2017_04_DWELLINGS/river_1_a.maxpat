...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 945.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 345.0, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "gl_cornerpin.module.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 1170.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 1020.0, 300.0, 140.0 ],
					"presentation_rect" : [ 15.0, 15.0, 300.0, 140.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 795.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 195.0, 300.0, 140.0 ],
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "combine PATH river_1.cues.txt"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 1350.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 30.0, 1395.0, 228.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 1350.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 1024.5, 24.5, 1024.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-30::obj-1::obj-46" : [ "live.toggle[2]", "live.toggle", 0 ],
			...
			"obj-32::obj-5::obj-36" : [ "live.text[59]", "live.text", 0 ],
			"obj-30::obj-1::obj-91" : [ "live.toggle[13]", "live.toggle", 0 ],
			...
			"obj-30::obj-1::obj-121" : [ "live.text[46]", "live.text[6]", 0 ],
			...
			"obj-30::obj-1::obj-60" : [ "live.toggle[8]", "live.toggle", 0 ],
			...
			"obj-30::obj-1::obj-51" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-2::obj-69" : [ "SelectFile[1]", "SelectFile", 0 ],
			"obj-50::obj-1::obj-1::obj-45" : [ "live.text[37]", "live.text", 0 ],
			"obj-30::obj-1::obj-87" : [ "live.toggle[11]", "live.toggle", 0 ],
			"obj-11::obj-1::obj-12::obj-15" : [ "Postamp", "Postamp", 0 ],
			"obj-32::obj-5::obj-53" : [ "live.button[1]", "live.button", 0 ],
			"obj-30::obj-1::obj-57" : [ "live.toggle[3]", "live.toggle", 0 ],
			...
			"obj-32::obj-5::obj-39" : [ "live.text[57]", "live.text", 0 ],
			...
			"obj-30::obj-1::obj-97" : [ "live.toggle[16]", "live.toggle", 0 ],
			...
			"obj-32::obj-5::obj-91" : [ "live.text[54]", "live.text[2]", 0 ],
			...
			"obj-30::obj-1::obj-93" : [ "live.toggle[14]", "live.toggle", 0 ],
			"obj-30::obj-1::obj-126" : [ "live.text[51]", "live.text[6]", 0 ],
			"obj-11::obj-1::obj-12::obj-13" : [ "Release", "Release", 0 ],
			"obj-48::obj-1::obj-59" : [ "live.text[33]", "live.text[3]", 0 ],
			"obj-32::obj-5::obj-49" : [ "live.button", "live.button", 0 ],
			...
			"obj-30::obj-1::obj-63" : [ "live.toggle[7]", "live.toggle", 0 ],
			...
			"obj-32::obj-5::obj-41" : [ "live.text[56]", "live.text[4]", 0 ],
			"obj-30::obj-1::obj-89" : [ "live.toggle[12]", "live.toggle", 0 ],
			...
			"obj-32::obj-5::obj-89" : [ "live.text[55]", "live.text[2]", 0 ],
			...
			"obj-30::obj-1::obj-122" : [ "live.text[47]", "live.text[6]", 0 ],
			"obj-30::obj-1::obj-66" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-48::obj-1::obj-62" : [ "live.text[32]", "live.text[3]", 0 ],
			"obj-11::obj-1::obj-12::obj-45" : [ "live.text[22]", "live.text", 0 ],
			"obj-30::obj-1::obj-69" : [ "live.toggle[5]", "live.toggle", 0 ],
			"obj-30::obj-1::obj-125" : [ "live.text[50]", "live.text[6]", 0 ],
			"obj-2::obj-7::obj-124::obj-182" : [ "live.text[1]", "live.text[4]", 0 ],
			"obj-50::obj-1::obj-1::obj-15" : [ "Postamp[2]", "Postamp", 0 ],
			"obj-30::obj-1::obj-85" : [ "live.toggle[10]", "live.toggle", 0 ],
			"obj-11::obj-1::obj-98" : [ "live.menu[12]", "live.menu", 0 ],
			"obj-30::obj-1::obj-37" : [ "live.toggle[1]", "live.toggle", 0 ],
			...
			"obj-30::obj-1::obj-127" : [ "live.text[52]", "live.text[6]", 0 ],
			"obj-48::obj-1::obj-47" : [ "live.numbox[4]", "live.numbox", 0 ],
			"obj-30::obj-1::obj-134" : [ "live.text[53]", "live.text[6]", 0 ],
			...
			"obj-30::obj-1::obj-95" : [ "live.toggle[15]", "live.toggle", 0 ],
...
, 			{
				"name" : "gl_cornerpin.module.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/unstable/gl_cornerpin",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "gl_cornerpin.model.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/unstable/gl_cornerpin",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "gl_cornerpin.view.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/unstable/gl_cornerpin",
				"type" : "JSON",
				"implicit" : 1
			}
