...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 30.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "xosc_imu.model xosc_4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 30.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "xosc_imu.model xosc_3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 30.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "xosc_imu.model xosc_2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 60.0, 181.0, 22.0 ],
					"style" : "",
					"text" : "xosc_scale_model leg_r xosc_4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 60.0, 179.0, 22.0 ],
					"style" : "",
					"text" : "xosc_scale_model leg_l xosc_3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 60.0, 185.0, 22.0 ],
					"style" : "",
					"text" : "xosc_scale_model arm_r xosc_2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 30.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "xosc_imu.model xosc_1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 60.0, 184.0, 22.0 ],
					"style" : "",
					"text" : "xosc_scale_model arm_l xosc_1"
				}
...
, 			{
				...
				"bootpath" : "~/Github/TML-depo/PROJECTS/2017_10_NAEL/_x-OSC/xosc_translate",
				"patcherrelativepath" : "../xosc_translate",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
