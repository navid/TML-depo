...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 255.0, 135.0, 180.0, 45.0 ],
					"style" : "",
					"text" : "j.return out/final/abs @type float @description \"final output\" @repetitions/filter 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 255.0, 105.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "abs 1."
				}
