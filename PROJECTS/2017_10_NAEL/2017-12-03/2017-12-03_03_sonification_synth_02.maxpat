...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.0, 60.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 690.0, 15.0, 154.0, 22.0 ],
					"style" : "",
					"text" : "j.message arm_l-az-scaled"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1050.0, 675.0, 50.0, 35.0 ],
					"style" : "",
					"text" : "-199.922936"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.0, 210.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "scale 0 1 0 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 900.0, 180.0, 149.0, 22.0 ],
					"style" : "",
					"text" : "j.receive arm_r-roll-scaled"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 825.0, 210.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 360.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 300.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 720.0, 270.0, 50.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 720.0, 240.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "counter 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 720.0, 210.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 660.0, 345.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 480.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1110.0, 615.0, 123.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 795.0, 180.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 720.0, 135.0, 183.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 885.0, 75.0, 129.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 1020.0, 300.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 555.0, 405.0, 369.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1185.0, 345.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1125.0, 345.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "* 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1125.0, 315.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "abs 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1125.0, 270.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "- 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 615.0, 300.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "+ 48"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1125.0, 195.0, 120.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 990.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "r to_synth"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 774.5, 617.0, 944.850003, 617.0, 944.850003, 334.0, 680.0, 334.0 ],
					"order" : 1,
					"source" : [ "obj-143", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-154", 1 ],
					"midpoints" : [ 819.5, 618.0, 942.0, 618.0, 942.0, 339.0, 680.0, 339.0 ],
					"order" : 1,
					"source" : [ "obj-145", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-154", 1 ],
					"midpoints" : [ 864.5, 618.0, 942.0, 618.0, 942.0, 339.0, 680.0, 339.0 ],
					"order" : 1,
					"source" : [ "obj-147", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-154", 1 ],
					"midpoints" : [ 909.5, 609.0, 942.0, 609.0, 942.0, 339.0, 680.0, 339.0 ],
					"order" : 1,
					"source" : [ "obj-148", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 219.5, 1015.5, 219.5, 1015.5 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1166.5, 258.0, 1134.5, 258.0 ],
					"source" : [ "obj-62", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "2017-10-26_nael_01_main_patch_20171203_3.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"origin" : "2017-12-03_03_sonification_synth_02",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 0,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "2017-10-26_nael_01_main_patch",
							"filename" : "2017-10-26_nael_01_main_patch_20171203_3.maxsnap",
							"filepath" : "~/Documents/Max 7/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "d5f4c0e1dae711ae9d61c0a1615cec12"
						}
