...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 120.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "context flowmix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 300.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "context flowmix"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.0, 165.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 480.0, 600.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.0, 450.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 450.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 630.0, 480.0, 252.0, 22.0 ],
					"style" : "",
					"text" : "jit.movie @output_texture 1 @drawto flowmix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 330.0, 480.0, 252.0, 22.0 ],
					"style" : "",
					"text" : "jit.movie @output_texture 1 @drawto flowmix"
				}
...
, 							{
								"box" : 								{
									"code" : "x_l = floor(in1.g * -1.);\r\nx_r = ceil(in1.r * 0.5);\r\nthresh = (in1.r + in1.g) > 0.01;\r\nsum = x_l + x_r;\r\n/*if(x_l>0.001)\r\n{\r\n\tout1 = in2;\r\n}\r\nif(x_r>0.01)\r\n{\r\n\tout1 = in3;\r\n}*/\r\nout1 = mix(in2,in3, sum) * thresh;",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 90.0, 435.0, 255.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 420.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 300.0, 525.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix"
				}
...
,
					"patching_rect" : [ 300.0, 330.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.0, 360.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 555.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 135.0, 525.0, 95.0, 22.0 ],
					"style" : "",
					"text" : "jit.world flowmix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 300.0, 60.0, 305.0, 22.0 ],
					"style" : "",
					"text" : "jit.grab @output_texture 1 @unique 1 @drawto flowmix"
				}
...
,
					"patching_rect" : [ 300.0, 90.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix flowmix"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 348.0, 300.0, 209.0, 31.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 81.0, 274.0, 384.0, 21.0 ],
									"style" : "",
									"text" : "jit.gl.slab flowmix @file ab.hsflow.jxs @dimscale 0.25 0.25 @type float32"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 329.0, 189.0, 172.0, 21.0 ],
									"style" : "",
									"text" : "jit.gl.slab flowmix @type float32"
								}
...
,
					"patching_rect" : [ 300.0, 240.0, 76.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 300.0, 120.0, 174.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.slab flowmix @type float32"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 309.5, 115.5, 309.5, 115.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 639.5, 513.0, 341.5, 513.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 339.5, 589.0, 144.5, 589.0 ],
					"source" : [ "obj-3", 0 ]
				}
