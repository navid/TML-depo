...
,
									"patching_rect" : [ 7.0, 77.0, 55.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 7.0, 44.0, 113.0, 22.0 ],
									"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 132.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "dripCone"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "audio.connect", "" ],
									"patching_rect" : [ 24.0, 268.0, 114.0, 20.0 ],
									"style" : "",
									"text" : "j.gain= @interpolated 1"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 33.5, 293.0, 314.0, 293.0, 314.0, 576.0, 256.5, 576.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 319.0, 123.0, 79.0, 22.0 ],
									"style" : "",
									"text" : "loadmess 83"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 235.0, 287.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 235.0, 315.0, 24.0, 22.0 ],
									"style" : "",
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 235.0, 259.0, 76.0, 22.0 ],
									"style" : "",
									"text" : "delay 24000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 235.0, 341.0, 26.0, 26.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 58.0, 231.0, 196.0, 22.0 ],
									"style" : "",
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 146.5, 259.0, 76.0, 22.0 ],
									"style" : "",
									"text" : "delay 19000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.0, 297.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "init"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.0, 323.0, 128.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "j.receive /boilCues/read/done 1000"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 156.0, 289.5, 67.5, 289.5 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 			{
				"name" : "j.nav.rogsLive=.module.maxpat",
				"bootpath" : "~/Documents/code/Nav/Jamoma-v1/j.nav.rogslive~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "nav.gain~.maxpat",
				"bootpath" : "~/Documents/code/Nav/snd",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "j.nav.scale~.module.maxpat",
				"bootpath" : "~/Documents/code/Nav/Jamoma-v1/j.nav.scale~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/code/Nav/Jamoma-v1/j.nav.autoscale~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "j.route~.maxpat",
				"bootpath" : "~/Documents/code/Nav/Jamoma-v1/j.route~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "j.nav.clip~.model.maxpat",
				"bootpath" : "~/Documents/code/Nav/Jamoma-v1/j.nav.clip~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/code/TML-depo/PROJECTS/2016_09_AQUAPHONEIA/BOIL/coneDrip",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "dot.debounce.maxpat",
				"bootpath" : "~/Documents/code/SearchPath/dot_20121204/timing/dot.debounce",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
