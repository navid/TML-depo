...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 199.0, 393.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 6.0, 65.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "snapshot~ 50"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.0, 19.0, 150.0, 350.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.5, 7.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "r drop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 204.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "s drop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 53.859375, 94.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.859375, 119.0, 115.0, 23.0 ],
					"style" : "",
					"text" : "t 0.6 0.4 2200"
				}
...
,
					"patching_rect" : [ 6.0, 175.0, 162.578125, 23.0 ],
...
,
					"patching_rect" : [ 6.0, 148.0, 114.71875, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 304.0, 133.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "t b clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 262.5, 45.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 262.5, 133.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 262.5, 104.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "urn 14"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 199.0, 361.0, 166.0, 28.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 262.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 199.0, 217.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "counter 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 199.0, 300.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 262.5, 166.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b 1 i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 217.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "open $1.aif"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 421.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "dac~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 273.0, 300.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 282.5, 341.5, 208.5, 341.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 272.0, 202.5, 208.5, 202.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 293.0, 205.5, 304.5, 205.5 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 304.5, 353.0, 208.5, 353.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 347.5, 165.0, 362.75, 165.0, 362.75, 97.0, 272.0, 97.0 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 313.5, 172.0, 370.75, 172.0, 370.75, 87.0, 272.0, 87.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 1 ],
					"midpoints" : [ 304.5, 250.5, 282.5, 250.5 ],
					"source" : [ "obj-8", 0 ]
				}
