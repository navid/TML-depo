...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 337.0, 97.0, 119.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 184.0, 93.0, 32.5, 20.0 ],
													"text" : "> 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 90.0, 85.0, 59.0, 20.0 ],
													"text" : "jcom.hub"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 184.0, 120.0, 137.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 297.0, 7.0, 25.0, 25.0 ]
												}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 159.0, 4.0, 32.5, 20.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 311.5, 74.0, 32.5, 20.0 ],
									"text" : "> 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 311.5, 54.0, 39.0, 20.0 ],
									"text" : "r flow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "audio.connect" ],
									"patching_rect" : [ 2.0, 54.0, 300.0, 140.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 23.0, 236.0, 149.0, 103.0 ],
									"presentation" : 1,
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 294.5, 175.25, 119.166664, 175.25 ],
									"source" : [ "obj-45", 2 ]
								}
