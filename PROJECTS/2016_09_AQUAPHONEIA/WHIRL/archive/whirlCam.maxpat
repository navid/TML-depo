...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 146.0, 69.0, 20.0 ],
									"text" : "delay 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 173.5, 52.0, 18.0 ],
									"text" : "select 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 126.0, 95.0, 20.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 126.0, 146.0, 131.0, 18.0 ],
									"text" : "load whirlCamCues.txt"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.initialized /whirlCamCues"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.0, 251.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 6.0, 57.5, 36.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 86.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 57.5, 147.0, 20.0 ],
					"text" : "udpsend 127.0.0.1 98986"
				}
...
,
					"patching_rect" : [ 63.0, 8.5, 93.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 30.5, 109.0, 20.0 ],
