...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 936.0, 268.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 936.0, 414.0, 300.0, 70.0 ],
					"presentation_rect" : [ 936.0, 414.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 653.166687, 579.5, 128.333328, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.166687, 599.5, 71.0, 17.0 ],
					"text" : "midiGain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 567.166687, 628.0, 157.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 567.166687, 655.0, 185.66655, 20.0 ],
					"text" : "jcom.unpack≈ 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 443.0, 579.5, 128.333328, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 599.5, 71.0, 17.0 ],
					"text" : "midiGain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 357.0, 628.0, 157.0, 20.0 ],
					"text" : "jcom.gain≈ @interpolated 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 357.0, 598.0, 81.0, 20.0 ],
					"text" : "jcom.pack≈ 4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 625.0, 122.5, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 357.0, 655.0, 185.666656, 20.0 ],
					"text" : "jcom.unpack≈ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 314.0, 551.5, 298.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 314.0, 683.0, 461.166656, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "ircamverb~ @numsources 8 @numspeakers 4 @numinternals 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 906.0, 90.0, 29.0, 25.5 ]
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.0, 19.0, 36.0, 21.0 ],
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 2.0, 26.0, 640.0, 480.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 1.0, 1.0, 640.0, 480.0 ]
												}
...
,
									"patching_rect" : [ 342.0, 291.0, 62.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 200.0, 204.0, 150.0, 70.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 331.0, 371.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 357.0, 28.0, 93.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 78.0, 2.0, 224.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 233.0, 28.0, 86.0, 18.0 ],
					"text" : "/audio/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 314.0, 117.0, 253.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2.0, 26.0, 224.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.0, 50.0, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 394.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.0, 73.0, 117.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 323.5, 605.5, 323.5, 605.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-30::obj-89" : [ "lock[2]", "Lock", 0 ],
			"obj-30::obj-43::obj-131::obj-54::obj-9::obj-61" : [ "TriggersMode[4]", "Mode", 0 ],
			"obj-6::obj-117" : [ "ExcitationLPosX", "PosX", 0 ],
			"obj-30::obj-108::obj-15" : [ "Size[2]", "Size", 0 ],
			"obj-2::obj-35::obj-69" : [ "live.tab[1]", "live.tab", 0 ],
			"obj-13::obj-18" : [ "Clear", "Clear", 0 ],
			"obj-30::obj-43::obj-15" : [ "Append[4]", "Append", 0 ],
			"obj-30::obj-108::obj-67" : [ "SelectAll[1]", "SelectAll", 0 ],
			"obj-6::obj-100" : [ "ExcitationRandRate", "Rate", 0 ],
			"obj-6::obj-157" : [ "PickupLPosX[1]", "PosX", 0 ],
			"obj-30::obj-108::obj-87" : [ "Direction[11]", "Direction", 0 ],
			...
			"obj-30::obj-108::obj-49" : [ "Append[3]", "Append", 0 ],
			...
			"obj-30::obj-50" : [ "Rec[2]", "Rec", 0 ],
			"obj-6::obj-125" : [ "PickupRPosX", "PosX", 0 ],
			"obj-30::obj-74" : [ "note[2]", "Note", 0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../Nav/GestureBending/Motion/motionTrack",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "/Users/NavNav/code/Git/Nav/Projects/2015 06 Akiko",
				"patcherrelativepath" : "../../../../Nav/Projects/2015 06 Akiko",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
