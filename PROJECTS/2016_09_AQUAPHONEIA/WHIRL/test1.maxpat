...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 439.0, 531.0, 214.333328, 20.0 ],
					"text" : "jcom.unpack≈ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 314.0, 495.5, 116.0, 47.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "ircamverb~.control @numsources 4 @numspeakers 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 314.0, 562.0, 353.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "ircamverb~ @numsources 4 @numspeakers 4 @numinternals 8"
				}
...
,
					"patching_rect" : [ 314.0, 394.0, 36.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 906.0, 90.0, 36.0, 25.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 625.0, 418.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 418.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 323.5, 549.5, 323.5, 549.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/NavNav/code/Git/Nav/Projects/2015 05 Internstitial 2.0",
				"patcherrelativepath" : "../../../../Nav/Projects/2015 05 Internstitial 2.0",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
